        ...
        mounted() {
            Echo.join(`chat`)
                ...
                .joining((user) => {
                    ...
                    this.flashMessage.success({title: `${user.name} has joined`, message: 'Welcome to Morley\'s Dahboard!'});

                })
                .leaving((user) => {
                    this.flashMessage.error({title: `${user.name} has left`, message: 'Welcome to Morley\'s Dahboard!'});
                });
        },
        methods: {
    showText() {
